...
export default function EditBook() {
    ...
    return (
        <div className="my-10 mx-5 md:mx-20 lg:mx-40 flex gap-8 justify-center">
            <div className="w-1/2">
                <h4 className="font-serif text-2xl md:text-3xl font-bold mb-3 md:mb-6">Edit Book</h4>
                <div>
                        ...
                        <div className="flex justify-end mt-8">
                            {isLoading ? (
                                ...
                                <button
                                    ...
                                    Edit Book <img src="assets/icon/book-white.png" alt="" className="h-6" />
                                </button>
                            )}
                        </div>
                    </form>
